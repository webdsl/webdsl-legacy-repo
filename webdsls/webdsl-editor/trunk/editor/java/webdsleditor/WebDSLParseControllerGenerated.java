...
public class WebDSLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("WebDSL");
  ...
  { 
    WebDSLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = WebDSLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = WebDSLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(WebDSLParseControllerGenerated.class);
    }
  ...
  { 
    return WebDSLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
