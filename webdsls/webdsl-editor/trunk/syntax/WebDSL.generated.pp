[
   ...
   SearchMappingEmbedded                                  -- KW["search"] KW["mapping"] KW["{"] _1 KW["}"],
   SearchMappingEmbedded.1:iter-star                      -- _1,
   SearchMapping                                          -- KW["search"] KW["mapping"] _1 KW["{"] _2 KW["}"],
   ...
   QueryDef                                               -- V  [H  [KW["matching"]] _1],
   QueryDef.1:iter-star                                   -- _1,
   Start                                                  -- KW["offset"] _1,
   MaxResults                                             -- KW["limit"] _1,
   SortBy                                                 -- V  [H  [KW["order"] KW["by"]] _1],
   SortBy.1:iter-sep                                      -- _1 KW[","],
   ConstraintFilter                                       -- V  [H  [KW["with"] KW["filter"]] _1],
   ConstraintFilter.1:iter-sep                            -- _1 KW[","],
   ConstraintFilter                                       -- V  [H  [KW["with"] KW["filters"]] _1],
   ConstraintFilter.1:iter-sep                            -- _1 KW[","],
   ...
   NoLucene                                               -- KW["no"] KW["lucene"],
   Lucene                                                 -- KW["lucene"],
   DefaultAnd                                             -- KW["strict"] KW["matching"],
   DefaultOr                                              -- KW["loose"] KW["matching"],
   DiscreteFacetDef                                       -- KW["("] _1 KW[","] _2 KW[")"],
   RangeFacetDef                                          -- KW["("] _1 KW[":"] _2 KW[")"],
   RangeFacetDef.2:iter-star-sep                          -- _1 KW[","],
   ...
   SearchResults                                          -- KW["results"] KW["from"] _1,
   FacetResults                                           -- _1 KW["facets"] KW["from"] _2,
   AllFacetResults                                        -- KW["all"] _1 KW["facets"] KW["from"] _2,
   SearchResultsSize                                      -- KW["count"] KW["from"] _1,
   SearchTimeString                                       -- KW["searchtime"] KW["from"] _1,
