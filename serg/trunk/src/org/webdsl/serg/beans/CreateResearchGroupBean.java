...
{ 
  ...
  { 
    ...
    ResearchGroup var61 = new ResearchGroup();
    researchGroup = var61;
    initPerson186List();
  ...
  { 
    this.getResearchGroup().getMembers().remove(person185);
  }

  public void addPerson13(Person person185)
  { 
    this.getResearchGroup().getMembers().add(person185);
  }
