...
{ 
  ...
  { 
    ...
    InProceedings var46 = new InProceedings();
    inProceedings = var46;
  ...
  { 
    this.getInProceedings().getAuthors().remove(person175);
  }

  public void addPerson5(Person person175)
  { 
    this.getInProceedings().getAuthors().add(person175);
  }
