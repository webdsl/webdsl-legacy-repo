...
{ 
  ...
  public void removePerson4(Person person173)
  { 
    this.getInProceedings().getAuthors().remove(person173);
  }

  public void addPerson4(Person person173)
  { 
    this.getInProceedings().getAuthors().add(person173);
  }
