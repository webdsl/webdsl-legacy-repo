...
{ 
  ...
  { 
    ...
    if(id > 0)
    { 
      Shop shop15 = em.find(Shop.class, id);
      setShop0(shop15);
    }
  }
  ...
  { 
    ...
    if(id > 0)
    { 
      Product product20 = em.find(Product.class, id);
      setProduct4(product20);
    }
  }
  ...
  { 
    ...
    if(id > 0)
    { 
      Product product22 = em.find(Product.class, id);
      setProduct5(product22);
    }
  }
