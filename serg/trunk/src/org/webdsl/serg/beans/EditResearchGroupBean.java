...
{ 
  ...
  public void removePerson12(Person person193)
  { 
    this.getResearchGroup().getMembers().remove(person193);
  }

  public void addPerson12(Person person193)
  { 
    this.getResearchGroup().getMembers().add(person193);
  }
