...
{ 
  ...
  public void removePerson11(Person person180)
  { 
    this.getResearchProject().getMembers().remove(person180);
  }

  public void addPerson11(Person person180)
  { 
    this.getResearchProject().getMembers().add(person180);
  }
