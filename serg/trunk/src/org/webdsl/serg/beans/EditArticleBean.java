...
{ 
  ...
  public void removePerson8(Person person183)
  { 
    this.getArticle().getAuthors().remove(person183);
  }

  public void addPerson8(Person person183)
  { 
    this.getArticle().getAuthors().add(person183);
  }
