...
@Stateful @Scope(SESSION) @Name("personListBean") public class PersonList  implements IPersonList
{ 
  @Logger private Log log;

  @In FacesMessages facesMessages;

  @DataModel private List<Person> personList;

  @DataModelSelection @Out(required = false) private Person person;

  @PersistenceContext(type = EXTENDED) private EntityManager em;

  @Factory("personList") public void findEntries()
  { 
