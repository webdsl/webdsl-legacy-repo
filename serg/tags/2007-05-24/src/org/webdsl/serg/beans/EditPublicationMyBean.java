...
@Stateful @Name("editPublicationMy") public class EditPublicationMyBean  implements EditPublicationMyBeanInterface
{ 
  ...
  { 
    return "/" + "viewPublication" + ".seam?" + ("publication" + "=" + pub.getId() + "");
  }
